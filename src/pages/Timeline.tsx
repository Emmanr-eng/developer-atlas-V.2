  ...
  return (
    <div className="space-y-10">
      <div className="space-y-3">
        <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-red-50 border border-red-200 text-red-500 text-[11px] font-medium uppercase tracking-wider">
          <Bug className="w-3 h-3" />
          <span>Debugging Ledger</span>
        </div>
        <h1 className="text-3xl font-semibold tracking-tight text-neutral-900">Bug Timeline</h1>
          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                isExpanded ? "p-6 md:p-8 border-neutral-300 shadow-sm" : "p-5 cursor-pointer border-neutral-200 hover:border-neutral-300"
              )}
              id={item.id}
            ...
            >
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  <div className={cn(
                    ...
                    isExpanded ? "bg-red-50 border-red-200" : "bg-neutral-50 border-neutral-200"
                  )}>
                    <AlertCircle className={cn("w-5 h-5 transition-colors", isExpanded ? "text-red-500" : "text-neutral-400")} />
                  </div>
                  <h2 className={cn(
              ...
              <AnimatePresence initial={false}>
                {isExpanded && (
                  ...
                  >
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pt-6 border-t border-neutral-200">
                      {/* Problem Section */}
                      <div className="space-y-4">
                        <div className="space-y-2">
                          <p className="text-[11px] font-medium text-red-500 uppercase tracking-wider flex items-center gap-2">
                        ...
                        <div className="p-4 bg-red-50 border border-red-100 rounded-lg font-mono text-xs text-red-700 leading-relaxed overflow-x-auto">
                          <p className="text-[10px] text-red-400 mb-2 font-medium uppercase tracking-wider font-sans">Trigger Code</p>
                      ...
                      <div className="space-y-4">
                        <div className="space-y-2">
                          <p className="text-[11px] font-medium text-emerald-600 uppercase tracking-wider flex items-center gap-2">
                        ...
                        <div className="p-4 bg-emerald-50 border border-emerald-100 rounded-lg font-mono text-xs text-emerald-700 leading-relaxed overflow-x-auto">
                          <p className="text-[10px] text-emerald-500 mb-2 font-medium uppercase tracking-wider font-sans">Resolution</p>
